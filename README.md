<div align="center"> <h1>TrafficFlow-Analyzer</h1> <p> A lightweight Python network traffic log analyzer. It reads sFlow/NetFlow-style CSV flow records and produces top talkers/listeners, protocol distribution, top application ports, and a sampling-aware total traffic estimate. It also exports results to Excel, generates PNG visualizations, and writes a plain-text report. </p> <!-- Banner image placeholder --> <!-- Put your banner at: assets/banner.png --> <img src="assets/banner.png" alt="banner" width="900" /> <p> <img src="https://img.shields.io/badge/Python-3.8%2B-blue" alt="Python"/> <img src="https://img.shields.io/badge/Outputs-XLSX%20%7C%20PNG%20%7C%20TXT-orange" alt="Outputs"/> </p> </div>
Key Features
...
lab4_4E_bar.png — horizontal bar chart of top bidirectional pairs (packet counts)

lab4_4E_talker_network.png — star-shaped network graph: Top Talker → targets (edge width encodes traffic)

lab4_4E_listener_network.png — star-shaped network graph: Sources → Top Listener (edge width encodes traffic)

<!-- Figure placeholders --> <!-- Put images at: assets/example_bar.png assets/example_talker_network.png assets/example_listener_network.png --> <div align="center"> <img src="assets/example_bar.png" alt="bar chart" width="48%"/> <img src="assets/example_talker_network.png" alt="talker network" width="48%"/> </div> <div align="center"> <img src="assets/example_listener_network.png" alt="listener network" width="60%"/> </div>
Text Report (TXT)
...
Note: the report header contains legacy wording; edit the corresponding write() line if you want a custom title.
